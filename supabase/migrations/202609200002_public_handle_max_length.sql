-- FACt.Smack renders public IDs beside actions on a compact mobile header.
-- Twelve characters keeps that identity readable across Korean and English UI.
...
begin
  ...
  if normalized_handle !~ '^[a-z0-9_]{3,12}$' or normalized_handle like 'member_%' then
