...
| BE-08 | 팔로우·차단 관계·가시성 인가 | 승인 없는 단방향 Follow, 양방향 노출을 차단하는 Block, Post visibility(public/followers) 권한 검사를 서버에서 처리 | 진행 중 — 차단 관계와 피드·투표·스크랩·집계 조회를 함께 제한하는 SQL 마이그레이션 작성 및 로컬 트랜잭션 검증 완료. Follow·followers 공개 인가는 후속 연결 |
