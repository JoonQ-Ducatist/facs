...
test('landscape phone keeps a PC-style menu beside a fixed-width scrolling feed', async () => {
  ...
  assert.match(landscapeBlock, /\.editorial-main \{ position: relative !important; inset: auto !important; grid-column: 2; grid-row: 1; width: 430px; min-width: 430px; max-width: 430px; height: 100% !important; justify-self: center;/);
  ...
  assert.match(landscapeBlock, /\.editorial-main--feed \.media-carousel > article \{ display: block; width: 100%; height: 100%; min-height: 100%;/);
