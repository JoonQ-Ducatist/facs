...
export default function ProfileView({ locale = 'ko', cards, categories, savedPostIds, profile, profileLoading, profileNotice, isAuthenticated, onCheckHandle, onLoadHandleSuggestions, onSaveHandle, onDelete, onRemoveScrap, onUpload, onSignOut }) {
